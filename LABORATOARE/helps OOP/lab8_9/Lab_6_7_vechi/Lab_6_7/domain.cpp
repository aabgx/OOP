...
string Disciplina::get_denumire() {
	return this->denumire;
}

int Disciplina::get_ore_pe_saptamana() {
	return this->ore_pe_saptamana;
}

string Disciplina::get_tip() {
	return this->tip;
}

string Disciplina::get_cadru_didactic() {
...
bool Disciplina::egale(Disciplina d) {
	return this->get_denumire() == d.get_denumire();
}

string Disciplina::str() {
