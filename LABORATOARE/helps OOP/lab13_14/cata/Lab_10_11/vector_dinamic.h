...
//	}
//
//	//functie care returneaza dimensiunea vectorului dinamic
//	int size() {
//		return n;
//	}
//
...
//	void operator=(const vector<TElem>& v) {
//		this->n = v.n;
//		this->cp = v.cp;
//		delete[] this->elems;
//		this->elems = new TElem[cp];
...
//	int poz = 0;
//public:
//	IteratorVectorA(const vector<TElem>& v) noexcept;
//
//	IteratorVectorA(const vector<TElem>& v, int poz)noexcept;
//
//
//	/*
...
//
//template<typename TElem>
//IteratorVectorA<TElem>::IteratorVectorA(const vector<TElem>& v) noexcept :v{ v } {}
//
//template<typename TElem>
//IteratorVectorA<TElem>::IteratorVectorA(const vector<TElem>& v, int poz)noexcept : v{ v }, poz{ poz } {}
